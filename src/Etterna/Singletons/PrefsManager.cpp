...
PrefsManager::PrefsManager()
  ...
  , m_BGFitMode("BackgroundFitMode", BFM_CoverDistort)
  ...
  , m_MinTNSToHideNotes("MinTNSToHideNotes", TNS_Miss)
  ...
  , m_bHardRock("HardRock", false)
  , m_bCustomBG("CustomBG", false)
  , m_bDescendingSort("DescendingSort", false)
  , m_bEasterEggs("EasterEggs", false)
