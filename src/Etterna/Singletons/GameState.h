...
class GameState
{
  ...
  public:
	...
	static auto GetEtternaVersion() -> std::string { return "0.5"; }
	...
	std::vector<float> timingscaleswife = { 0.00F, 1.00F, 2.00F, 3.00F, 4.00F,
										5.00F, 6.00F, 7.00F, 8.00F, 9.00F, 10.00F };
